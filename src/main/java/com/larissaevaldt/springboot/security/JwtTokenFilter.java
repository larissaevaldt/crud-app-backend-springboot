package com.larissaevaldt.springboot.security;
...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    private EmployeeAppUserDetailsService userDetailsService;

    public JwtTokenFilter(EmployeeAppUserDetailsService userDetailsService) {
